...
with st.sidebar:
    selected_page = option_menu(
        "Navigation", 
        ["AQI & Weather Analysis", "Jupyter Notebook Viewer"],
...
if selected_page == "AQI & Weather Analysis":
    ...
    CSV_PATH = r"C:\Users\seebi\Downloads\VSCODE_Projects\March_Team_Project-H\Outputs\DashBoardData\DashBoardData.csv"
